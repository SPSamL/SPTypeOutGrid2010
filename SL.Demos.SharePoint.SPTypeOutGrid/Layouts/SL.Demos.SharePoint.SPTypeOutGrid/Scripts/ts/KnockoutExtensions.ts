...
ko.observable.fn.beginEdit = function (transaction) {
    ...
    self.commit = function () {
        ...
        var dateFormats: string[] = ['M/D/YY', 'M-D-YY', 'MM/DD/YYYY', 'MM-DD-YYYY', 'M/D/YYYY', 'M-D-YYYY',
            'YYYY/MM/DD', 'YYYY-MM-DD', 'YY/M/D', 'YY-M-D', 
            'DD/MM/YYYY', 'DD-MM-YYYY', 'D/M/YYYY', 'D-M-YYYY', 'D/M/YY', 'D-M-YY', 'D/M/YYYY', 'D-M-YYYY'
        ];
